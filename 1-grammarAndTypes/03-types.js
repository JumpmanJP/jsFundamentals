...
// * Strings
let stringsOne = "double quotes";
let stringsTwo = 'single quotes';
console.log(stringsOne, stringsTwo);
...
//3- each item, regardless of datatype, is seperated by comas. 
...
//* If its a string and a number, it automatically console.logs string type.

let firstName = 'JP';
let lastName = 'Ogrady';
let houseNumber = '1705';
let street = 'King Eider Drive';
...
/* Methods
*******
Methods are like tools that can hel us maniuplate our data.
